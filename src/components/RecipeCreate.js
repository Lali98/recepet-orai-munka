...
export function RecipeCreate() {
    const [ingradientIds, setIngradientIds] = useState([]);
    ...
    return (<div className='card p-3'>
        ...
        >
            ...
            <div className='form-group row pb-3 border-bottom'>
                ...
                {ingradientIds.map((ingradientId, i) => (<div className='col-sm-10 offset-2'>
                        ...
                        <div className='col-md-2'>
                            <div className='w-100'>
                                <button className='btn btn-danger mb-3' type='button' onClick={() => {
                                    setIngradientIds((prevIds) => {
                                        const ret = [...prevIds];
                                        ret.splice(prevIds.findIndex((id) => id === ingradientId), 1)
                                        return ret;
                                    });
                ...
                <div className='w-100 row'>
                    <div className='col-md-3 offset-md-9'>
                        <button type='button' className='btn btn-success btn-sm float-right' onClick={() => {
                            setIngradientIds((prev) => [...prev, uuidv4()]);
            ...
            <button type='submit' className='btn btn-success btn-sm'>Küldés <FontAwesomeIcon icon={faCheckCircle}/>
            </button>
        </form>
    </div>)
}